...
def format_docs(docs):
    ...
    # print(Fore.RED + "retriever result: ", formatted_docs + '\n' + "-"*10 +'\n' + Fore.RESET)
...
topic_system = PromptTemplate(
    input_variables=["mbti", "age", "gender"],
...
all_topics = ['Politics', 'Urban Legends', 'Business', 'Terrorism & War', 'Science & Technology', 'Entertainment',
...
def generate_user_profile(age, gender, mbti, profession, topics):
    # topic_index = topic_chain.invoke({"age": age, "gender": gender, "mbti": mbti, "profession": profession})
    # print(topic_index)
...
if __name__ == '__main__':
    ...
    topics = [['Politics', 'Urban Legends'], ['Business'], ['Science & Technology', 'Entertainment']]
