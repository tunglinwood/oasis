...
from social_simulation.inference.inference_thread import InferenceThread, SharedMemory
        ...
        while True:
            for thread in self.threads:
                if thread.shared_memory.Done:
                    await self.channel.send_to((thread.shared_memory.Message_ID, thread.shared_memory.Response))
