...
2. **Simulation Cycle**:
   - For each simulation step:
     - Active agents observe their current state (timeline, notifications)
     - Agents decide what actions to take based on LLM reasoning
...
- **Time Settings**: Adjust the pace of the simulation
