...
2. **Realistic Social Connections**: If you want to create a social connection between agents, you can add some [`ManualAction`](key_modules/actions.mdx) during the simulation to let agents follow each other.

3. **Initial Content**: If you want to add some initial content to the agents, you can add some [`ManualAction`](key_modules/actions.mdx) during the simulation to let agents post some initial content.
