...
| `model`           | [`BaseModelBackend`](https://docs.oasis.camel-ai.org/key_modules/models.html) or `List[BaseModelBackend]` | ✗       | gpt-4o-mini | The large language model(s) used by the all agents. |
