...
| `semaphore` | `int` | Limit on concurrent LLM requests (default: 128) |
    ...
    For more details, see the [Platform](key_modules/platform), [Agent Profile](user_generation/user_generation), [Model](key_modules/models) and [Actions](key_modules/agent_graph) Module.
